    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col text-right">
                <a href="<?= base_url('poliklinik/add'); ?>" class="btn btn-info bg-gradient-info">
                    <i class="fas fa-plus"></i> Tambah Data
                </a>
                <!-- PDF Laporan -->
                <a href="<?= base_url('laporan/poliklinik'); ?>" target="_blank" class="btn btn-default bg-gradient-light">

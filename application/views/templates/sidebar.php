...
<aside class="main-sidebar sidebar-dark-info elevation-1">
    ...
    <a href="<?= base_url() ?>" class="brand-link bg-info text-center border-bottom-0">
        <span style="padding-left: 15px;">Aplikasi</span>
        <span class="brand-text font-weight-light">Mitra Keluarga</span>
    </a>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-legacy" data-widget="treeview" role="menu" data-accordion="false">
                <?php if (is_role(2)) : ?>
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url('pendaftaran') ?>" class="nav-link <?= active_menu('admin', 'pendaftaran'); ?>">
                    ...
                    <li class="nav-header text-uppercase">Medis</li>
                    <li class="nav-item">

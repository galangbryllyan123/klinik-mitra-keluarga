    ...
    <div class="card-header">
        <div class="row">
            ...
            <div class="col text-right">
                <a href="<?= base_url('dokter/add'); ?>" class="btn btn-info bg-gradient-info">
                    <i class="fas fa-plus"></i> Tambah Data
                </a>
                <!-- PDF Laporan -->
                <a href="<?= base_url('laporan/dokter'); ?>" target="_blank" class="btn btn-default bg-gradient-light">
                ...
                if (count((array) $dokter) > 0) : ?>
                    <?php foreach ($dokter as $row) : ?>
                        <tr>
                            ...
                            <td><?= $row->noTelp ?></td>
                            <td><?= $row->alamat ?></td>
                            <td>Rp. <?= number_format($row->biayaDokter, 0, ',', '.') ?></td>
                            <td>
                                <div class="btn-group">

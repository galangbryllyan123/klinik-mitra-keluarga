    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label>Foto</label><br/>
                    <?php if($dokter->fotoDokter): ?>
                    <img class="mb-2" src="<?= base_url($dokter->fotoDokter) ?>" width="100">
                    <br/>
                    <?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <input value="<?= set_value('biayaDokter', $dokter->biayaDokter); ?>" type="text" name="biayaDokter" id="biayaDokter" class="form-control" placeholder="Nomor Telepon">

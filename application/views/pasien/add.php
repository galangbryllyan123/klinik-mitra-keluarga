        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="<?= base_url('pendaftaran') ?>" class="btn btn-tool">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="kode">Kode Daftar Pasien</label>
                    <input readonly value="<?= 'PS-'.time(); ?>" type="text" id="kode" class="form-control" name="kode">
                </div>
                <div class="form-group">
